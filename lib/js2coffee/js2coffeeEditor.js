define(['lib/js2coffee/js2coffee', 'lib/js2coffee/coffee-script', 'lib/js2coffee/theme-github', 'lib/js2coffee/token_tooltip'], function () {
    ...
    var js2coffeeEditor = function () {
        ...
        this.init = function (model) {
            ...
            if (this.model && this.model().jsSourceStr()) {
                editorJS.getSession().getDocument().setValue(this.model().jsSourceStr());
                compileToCoffee();
            }
...
//            // Tooltips
            document.querySelector('#modal-js2coffeeEditor input[name="token_highlight"]').addEventListener('click', function (e) {
            ...
            document.querySelector('#model-js2coffeeEditor input[name="line_numbers"]').addEventListener('click', function (e) {
                var value = e.target.checked;
                js2coffeeOptions.show_src_lineno = value;
                compileToCoffee();
            });
            // js2coffee indent
            document.querySelector('#model-js2coffeeEditor select[name="js2coffee_indent"]').addEventListener('change', function (e) {
            ...
            var inputs = document.querySelectorAll('#model-options input.editor');
