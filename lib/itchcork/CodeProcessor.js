define(['./ToSource', 'lib/when', 'require', 'lib/js2coffee/js2coffee', "lib/ace/ext/static_highlight", "lib/ace/lib/dom", "lib/ace/theme/pastel_on_dark", "lib/ace/mode/coffee", "lib/ace/mode/javascript"]
                ...
                var buildCoffee = function () {
                    ...
                    $.get('_src/' + codeModel.moduleName + '.coffee',function (coffeeStr) {
                        ...
                        _this.deferred.resolve(codeModel);
                            ...
                            var coffeeStr = Js2coffee.build(codeModel.jsSourceStr().trim());

                            codeModel.coffeeSourceStr(_this.highlight(coffeeStr), _this.coffeeMode);
                            codeModel.processed(true);
                            _this.deferred.resolve(codeModel);
                        });
                };
