...
//            })(this);
            ...
            this.process = (function (_this) {
                return function (codeModel, root, thenAction) {
                    ...
                    $.get("/absolute", moduleInfo).done(
                        function (data) {
                            if (ItchCork.options.sourceExt === '.coffee') {
                                console.log(data.moduleSrc);
                                codeModel.coffeeSourceStr(data);
                            } else {
                                codeModel.jsSourceStr(moduleScript);
                            }
