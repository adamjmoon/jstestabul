...
(function (factory) {
    ...
    var defaults = {
        ...
        errorMessageClass: 'form-control-error',  // class to decorate error message
    ...
    ko.bindingHandlers['validationMessage'] = { // individual error message, if modified or post binding
        update: function (element, valueAccessor) {
            ...
            if (isCurrentlyVisible && !isVisible) {
                ...
                element.parentElement.className = element.parentElement.className.replace("is-invalid", "");
                element.parentElement.parentElement.className = element.parentElement.parentElement.className.replace("is-invalid", "");
            } else if (!isCurrentlyVisible && isVisible) {
                element.parentElement.className += " is-invalid";
                element.parentElement.parentElement.className += " is-invalid";
    ...
    ko.bindingHandlers['validationElement'] = {
        update: function (element, valueAccessor, allBindingsAccessor) {
            ...
            ko.bindingHandlers.attr.update(element, function () {
                ...
                // * Removed due to conflict with tipsy
...
//  )};
    ...
    ko.extenders['fieldName'] = function (observable, field) {

        observable.fieldName = field;
        return observable;
    };
...
// this will remove the validation properties from the Observable object should you need to do that.
    ...
    function validateSync(observable, rule, ctx) {
        ...
        if (!rule.validator(observable(), (ctx.params === undefined ? true : unwrap(ctx.params)))) { // default param is true, eg. required = true
            ...
            var params = unwrap(ctx.params)
            var value = kv.utils.isObject(params) ? params.value : params
